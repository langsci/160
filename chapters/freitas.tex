...
\textipa{/l/} final $>>$ \textipa{[n]} final $>>$ \textipa{/n/} medial $>>$ \textipa{/s/} final $>>$ \textipa{/l/} medial $>>$ \textipa{/r/} final $>>$ \textipa{/s/} medial $>>$ \textipa{/r/ medial}
\z
...
Casos de Codas\is{sílaba!coda} fricativas lexicais em final de palavra (\textit{lápis}, \textit{nariz}) são pouco frequentes nos dados das crianças, pelo que não é possível, até ao momento, estabelecer generalizações sobre a aquisição das mesmas. 
