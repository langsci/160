...
%%%                                              %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{parts/questoes_teoricas}%I
\includepaper{chapters/simsim}%1
\include{parts/percepcao}%II
...
\include{parts/aquisicao_sintaxe}%III
